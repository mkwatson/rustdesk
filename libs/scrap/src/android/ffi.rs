...
#[no_mangle]
pub extern "system" fn Java_dev_crab_cake_MainService_onVideoFrameUpdate(
    env: JNIEnv,
    _class: JClass,
    buffer: JObject,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_crab_cake_MainService_onAudioFrameUpdate(
    env: JNIEnv,
    _class: JClass,
    buffer: JObject,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_crab_cake_MainService_setFrameRawEnable(
    env: JNIEnv,
    _class: JClass,
    name: JString,
    value: jboolean,
...
#[no_mangle]
pub extern "system" fn Java_dev_crab_cake_MainService_init(
    env: JNIEnv,
    _class: JClass,
    ctx: JObject,
) {
